namespace console_game
{
    public class CollisionDetection
    {
        ...
        {
            Vector center1 = new Vector(circle1.Position.X + circle1.Radius, circle1.Position.Y + circle1.Radius);
            Vector center2 = new Vector(circle2.Position.X + circle2.Radius, circle2.Position.Y + circle2.Radius);
